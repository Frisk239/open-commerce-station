    ...
    <main className="grid min-h-screen place-items-center bg-[#f3f0e8] px-5 py-12 text-stone-950">
      <section className="w-full max-w-md rounded-[2rem] border border-stone-200 bg-white p-7 shadow-[0_24px_80px_rgba(28,25,23,0.10)] md:p-9">
        ...
        <form action={login} className="mt-8 space-y-5">
          ...
          <button type="submit" className="w-full rounded-full bg-stone-950 px-5 py-3 text-sm font-bold text-white hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:ring-offset-2">登录</button>
        </form>
        <Link href="/" className="mt-7 inline-block text-sm text-stone-500 underline decoration-stone-300 underline-offset-4">返回店面</Link>
      </section>
    </main>
  );
}
