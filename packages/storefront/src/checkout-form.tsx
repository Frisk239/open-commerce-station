...
function SubmitButton({ label, intent, className }: { readonly label: string; readonly intent: "quote" | "pay-alipay"; readonly className: string }) {
